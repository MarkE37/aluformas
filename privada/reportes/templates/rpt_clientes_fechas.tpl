     ...
     <head>
          ...
          <script type="text/javascript">
               function validar(){
                    ...
                    ventanaCalendario = window.open("rpt_clientes_fechas1.php?fecha1=" + fecha1 + "&fecha2=" + fecha2,"calendario","width=600, height=550, left=100, top=100, scrollbars=yes,menubars=no, statusbar=no, status=no, resizable=yes, location=no");
               }
          </script>
     </head>
     <body>
               ...
               <table width=100% border="0">
                    <tr>
                         ...
                         <td align="center" width="80%">
                              <h2>REPORTES DE CLIENTES CON FECHAS DE INSERCCION</h2>
                         </td>
